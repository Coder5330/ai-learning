...
const LEVELS = [
  ...
  {
    name: '7 · Warren',
    note: 'A proper maze with lava in the corridors and two crushers on patrol. Nearly a perfect maze, so there is close to one correct route and a lot of ways to waste a run.',
    rows: [
      '#########################',
      '#S#...#.......#.....#...#',
      '#.#.###.###.#.#.#.#.#.#.#',
    ...
    movers: [
      { kind: 'crusher', from: [11, 11], to: [18, 11], speed: 0.06, phase: 0.0 },
      { kind: 'crusher', from: [1, 9], to: [5, 9], speed: 0.06, phase: 0.5 },
    ],
  },
  {
    name: '8 · The Long Dark',
